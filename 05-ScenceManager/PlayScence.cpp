...
#define OBJECT_TYPE_TORCH_PILLAR	3
#define OBJECT_TYPE_VAMPIRE_KILLER	4
...
void CPlayScene::_ParseSection_OBJECTS(string line)
{
	...
	case OBJECT_TYPE_BACKGROUND: obj = new BackGrounds(); break;

	case OBJECT_TYPE_TORCH_PILLAR:
		obj = new Torch();
		break;

	case OBJECT_TYPE_VAMPIRE_KILLER:
		obj = VampireKiller::GetInstance();
		break;
...
void CPlayScenceKeyHandler::OnKeyDown(int KeyCode)
{
	...
	VampireKiller* vampireKiller = ((CPlayScene*)scence)->weapon;
	switch (KeyCode)
	{
	case DIK_X:
...
void CPlayScenceKeyHandler::OnKeyUp(int KeyCode)
{
	...
	//keycode 208 == down_dik
	if (KeyCode == 208) {
		if (simon->isCrouch == true)
			simon->CrouchControl(false);
	}
...
void CPlayScenceKeyHandler::KeyState(BYTE* states)
{
	...
	//combination key
	if (game->IsKeyDown(DIK_DOWN) && game->IsKeyDown(DIK_RIGHT))
	...
	//Non-combination
		...
		simon->SetState(SIMON_STATE_CROUCH_IDLE);
